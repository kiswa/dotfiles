...
[[ -z "$PROFILE_NAME" ]] && PROFILE_NAME="Base 16 Eighties 256"
[[ -z "$PROFILE_SLUG" ]] && PROFILE_SLUG="base-16-eighties-256"
[[ -z "$DCONF" ]] && DCONF=dconf
...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset cursor-background-color "'#d3d0c8'"
...
gset string cursor-background-color "'#d3d0c8'"
